...
/**
 * Hub for command line arguments for the MealPlannerMinIngredients
 * This one is for the second version that takes the amount of ingredients into account too
 */ 
public class MainMinIngredients {
	public static void main(String[] args) {
		...
		if (args.length >= 3) {
			...
			if (args[2].equals("Random")) {
    			...
    			// makes mealplans
				MealPlannerMinIngredients mealPlanner = new MealPlannerMinIngredients(recipesKnown, itemsOwned, nearbyStores);
